...
1. MVP 階段：完全免費、無廣告，聚焦穩定金流與同步機制。
2. 用戶穩定後：加入進階功能（自動發錢、通知歷史、報表匯出）再考慮小額訂閱。
3. 最終可行收費：一次性買斷 或 家庭共享永久版（NT$199–299），降低心理阻力。

使用情境

選擇零用金兌現方式 1. 現金、2轉帳，卡片 3. 直接消費付款

舉例: 

20251103 新增一筆零用金，媽媽轉帳   媽媽開的國泰卡 500
20251103 新增一筆零用金，媽媽現金   紅色小錢包 500
20251103 新增一筆零用金，媽媽購買   小積木 500

新增我的錢包 卡片(舉例:  媽媽開的國泰卡)、實體錢包(舉例:  紅色小錢包)、
