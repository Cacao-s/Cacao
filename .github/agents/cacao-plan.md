...
4. 必須先閱讀 `docs/gent-plan-log.md` 檢查當前任務
5. 找到當前任務編號(例如 P0001, P0002，如果是提問，在 gent-plan-log.md 回答問題
6. 找到當前任務編號(例如 P0001, P0002，如果是程式變更，在 gent-plan-log.md 留下變更概要說明
7. 檢查任務是否完成，如果工作完成，進一步把已完成的工作概要說明在，docs\product-features.md，保留對應任務編號
