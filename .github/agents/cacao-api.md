...
1. `docs/` 目錄內的文件內容一律使用繁體中文。
2. `docs/` 目錄內的檔案需使用英文命名，且長度少於 20 個字元。
3. 執行任務時，優先使用 wsl 進入 sub linux 使用 shell 腳本
4. 必須先閱讀 `docs/gent-api-log.md` 檢查當前任務
5. 找到當前任務編號(例如 B0001, B0002，如果是提問，在 gent-api-log.md 回答問題
6. 找到當前任務編號(例如 B0001, B0002，如果是程式變更，在 gent-api-log.md 留下變更概要說明
7. 檢查任務是否完成，如果工作完成，進一步把已完成的工作概要說明在，server\README.md，保留對應任務編號
